...
class SCurveElement(DrawingElement):
    ...
    def _update_control_points(self):
        ...
        # Calculate the perpendicular angle (90 degrees from base angle)
        perp_angle = base_angle + math.pi / 2
        
        # Calculate the intersection points
        # For the first circle
        intersection1_x = center1_x + radius * math.cos(perp_angle)
        intersection1_y = center1_y + radius * math.sin(perp_angle)
        
        # For the second circle
        intersection2_x = center2_x + radius * math.cos(perp_angle)
        intersection2_y = center2_y + radius * math.sin(perp_angle)
        ...
        self.control_points = [
            ...
            QPointF(intersection1_x, intersection1_y),  # Intersection point for first circle
            QPointF(intersection2_x, intersection2_y),  # Intersection point for second circle
            perp_angle  # Perpendicular angle
        ]
    ...
    def _draw_shape(self, painter):
        ...
        center1, center2, radius, intersection1, intersection2, perp_angle = self.control_points
        
        # Convert perp_angle from radians to degrees
        perp_angle_deg = perp_angle * 180 / math.pi
        
        # Calculate the start and end angles for each arc
        # For the first arc (from start to intersection1)
        start_angle1 = perp_angle_deg + 180  # Start from the opposite side
        span_angle1 = 180  # Half circle
        
        # For the second arc (from intersection2 to end)
        start_angle2 = perp_angle_deg  # Start from the perpendicular
        span_angle2 = 180  # Half circle
