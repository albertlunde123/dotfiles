...
class SCurveElement(DrawingElement):
    ...
    def _draw_shape(self, painter):
        ...
        # First half-circle: spans [θ - 90°, θ + 90°]
        start_angle1 = line_angle_deg - 90
        span_angle1 = 180  # Always positive for counterclockwise
        
        # Second half-circle: spans [θ + 90°, θ + 270°]
        start_angle2 = line_angle_deg + 90
        span_angle2 = 180  # Always positive for counterclockwise
