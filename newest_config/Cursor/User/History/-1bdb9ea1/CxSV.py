...
class SCurveElement(DrawingElement):
    ...
    def _draw_shape(self, painter):
        ...
        # For the first arc
        start_angle1 = line_angle_deg - 90  # Start perpendicular to the line
        span_angle1 = -180  # Draw clockwise
        
        # For the second arc
        start_angle2 = line_angle_deg + 90  # Start perpendicular to the line
        span_angle2 = 180  # Draw counterclockwise
