...
class SCurveElement(DrawingElement):
    ...
    def __init__(self, start_point, end_point, color=None):
        ...
        self.snap_points = [self.start_point, self.end_point]  # Add snap points
    ...
    def _draw_handles(self, painter):
        ...
        painter.drawEllipse(self.start_point, self.handle_size, self.handle_size)
        painter.drawEllipse(self.end_point, self.handle_size, self.handle_size)
        
        # Also draw handles at the centers of each half-circle for visual reference
        if self.control_points:
            center1, center2, _, _ = self.control_points
            painter.drawEllipse(center1, self.handle_size, self.handle_size)
            painter.drawEllipse(center2, self.handle_size, self.handle_size)
    ...
    def move(self, dx, dy):
        ...
        self._update_control_points()
        self.snap_points = [self.start_point, self.end_point]  # Update snap points
