...
class SCurveElement(DrawingElement):
    ...
    def _draw_shape(self, painter):
        ...
        # For the first arc (from start to middle)
        start_angle1 = line_angle_deg + 90  # Start from the perpendicular
        span_angle1 = 180  # Half circle
        
        # For the second arc (from middle to end)
        start_angle2 = line_angle_deg - 90  # Start from the opposite perpendicular
