...
class ToolController(QObject):
    ...
    def _initialize_tools(self):
        ...
        self.tools = {
            ...
            'line': line_tool,  # Straight line mode
    ...
    def set_active_tool(self, tool_name):
        ...
        if tool_name in self.tools:
            ...
            # Configure line tool mode if switching to line or s-curve
            if tool_name in ['line', 's_curve']:
                line_tool = self.tools[tool_name]
                line_tool.set_line_type(
                    LineTool.LINE_TYPE_STRAIGHT if tool_name == 'line' else LineTool.LINE_TYPE_SCURVE
                )
