...
class ToolController(QObject):
    ...
    def setup_menu(self, menu_bar):
        ...
        for tool_name in ['select', 'line', 'rectangle', 'circle', 'freehand', 'latex']:
            ...
            button.setStyleSheet(self.MAIN_BUTTON_STYLE)
            button.setMinimumWidth(100)  # Set minimum width for buttons
            ...
            if tool_name in self.TOOL_GROUPS:
                ...
                subtype_layout.setContentsMargins(15, 0, 0, 0)  # Add left margin for indentation
                ...
                for subtype in self.TOOL_GROUPS[tool_name]:
                    ...
                    subtype_button.setFixedHeight(25)  # Make subtype buttons smaller
                    subtype_button.setStyleSheet(self.SUB_BUTTON_STYLE)
