...
class RectangleElement(DrawingElement):
    ...
    def __init__(self, corner1, corner2, color):
        ...
        self._in_rotation_mode = False  # Flag for showing rotation UI
    ...
    def _draw_handles(self, painter: QPainter):
        ...
        # Draw rotation handle and circle only in rotation mode
        if self.selected and self.rotation_center and hasattr(self, '_in_rotation_mode') and self._in_rotation_mode:
