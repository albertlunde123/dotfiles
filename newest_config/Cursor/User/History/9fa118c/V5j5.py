...
class ElementPropertiesDock(QDockWidget):
    ...
    def __init__(self, parent=None):
        ...
        title_label.setStyleSheet("color: #c0caf5; font-weight: bold;")
        ...
        self.frame.setLineWidth(1.5)  # Make the border thicker
        ...
        thickness_label.setStyleSheet("color: #c0caf5;")
        ...
        dash_label.setStyleSheet("color: #c0caf5;")
        ...
        self.setStyleSheet("""
            ...
            QDockWidget:enabled QLabel, QDockWidget:disabled QLabel {
                color: #c0caf5;
            }
            QCheckBox {
                color: #c0caf5;
    ...
    def update_properties(self, elements: list):
        ...
        # Update dash pattern
        current_pattern = element.dash_pattern_key
