...
from PyQt5.QtWidgets import (
    ...
    QToolButton, QSpinBox, QCheckBox
)
...
class ElementPropertiesDock(QDockWidget):
    ...
    def __init__(self, parent=None):
        ...
        # --- Left/Right Checkboxes ---
        checkbox_layout = QHBoxLayout()
        self.left_checkbox = QCheckBox("Left")
        self.right_checkbox = QCheckBox("Right")
        self.left_checkbox.stateChanged.connect(lambda state: self._on_checkbox_changed("left", state))
        self.right_checkbox.stateChanged.connect(lambda state: self._on_checkbox_changed("right", state))
        checkbox_layout.addWidget(self.left_checkbox)
    ...
    def update_properties(self, elements: list):
        ...
        self.left_checkbox.blockSignals(True)
        self.right_checkbox.blockSignals(True)
        ...
        self.left_checkbox.setChecked(initial_start_arrow != "None")
        self.right_checkbox.setChecked(initial_end_arrow != "None")
        ...
        self.left_checkbox.blockSignals(False)
        self.right_checkbox.blockSignals(False)
