...
class LineTool(BaseTool):
    ...
    def __init__(self, line_color):
        ...
        self.current_points = []  # Renamed from current_polyline_points for clarity
        self.current_mouse_pos = None
        # Store snap info as a tuple: (QPointF | None, snap_type | None)
        self.current_snap_info = (None, None)
        self.snap_threshold = DEFAULT_ELEMENT_SNAP_THRESHOLD # Use default from snapping util

        self.perpendicular_mode = False
        self.perp_projected_point = None
        
        # New: track the current line type
    ...
    def _finalize_line(self):
        ...
        if len(self.current_points) > 1:
            # Create elements for each pair of consecutive points
    ...
    def draw(self, painter: QPainter):
        ...
        if len(self.current_points) > 1:
            ...
            # Draw points for straight lines
            if self.line_type == self.LINE_TYPE_STRAIGHT:
        ...
        if self.current_points and self.current_mouse_pos:
            ...
            if self.line_type == self.LINE_TYPE_STRAIGHT:
                ...
                preview = SCurveElement(self.current_points[-1], preview_end_point, self.preview_color)
