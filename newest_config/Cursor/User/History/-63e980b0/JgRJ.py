...
class SelectMoveTool(BaseTool):
    ...
    def __init__(self):
        ...
        self.snap_release_threshold_sq = self.snap_threshold**2 # Distance to move before snapping re-enables
    ...
    def mouseMoveEvent(self, event):
        ...
        if self.recently_snapped and self.pos_at_last_snap:
            ...
            if dist_sq_since_snap <= self.snap_friction_threshold_sq and not self.just_clicked:
        ...
        # Check if we've exceeded drag threshold (must happen after friction check)
