...
from .views.color_toolbar import ColorToolbar
from .views.grid_settings_dock import GridSettingsDock
from .views.element_properties_dock import ElementPropertiesDock
...
class MainWindow(QMainWindow):
    ...
    def _setup_toolbars(self):
        ...
        # Color toolbar only - tool toolbar is created in tool_controller.setup_menu
