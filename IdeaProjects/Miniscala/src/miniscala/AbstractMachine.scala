      ...
      while (code.nonEmpty) {
        ...
        inst match {
          ...
          case Eq =>
            val c2 = opstack.pop()
            val c1 = opstack.pop()
            if (c2 == c1) opstack.push(1) else opstack.push(0)
          case Lt =>
            val c2 = opstack.pop()
            val c1 = opstack.pop()
            if (c1 < c2) opstack.push(1) else opstack.push(0)
          case Leq =>
            val c2 = opstack.pop()
            val c1 = opstack.pop()
            if (c1 <= c2) opstack.push(1) else opstack.push(0)
          case And =>
            val c2 = opstack.pop()
            val c1 = opstack.pop()
            if (c1 == 1 & c2 == 1) opstack.push(1) else opstack.push(0)
          case Or =>
            val c2 = opstack.pop()
            val c1 = opstack.pop()
            if (c1 == 1 | c2 == 1) opstack.push(1) else opstack.push(0)
          ...
          case Not =>
            val c = opstack.pop()
            if (c == 0) opstack.push(1) else opstack.push(0)
