...
object Interpreter {
  ...
  def eval(e: Exp, env: Env, cenv: ClassEnv): Val = e match {
    ...
    case NewObjExp(klass, args) =>
      ...
      val declenv1 = evalArgs(args, c.params, env, cenv, c.env, e)
    ...
    case CallExp(funexp, args) =>
      ...
      val newEnv = evalArgs(args, closure.params, env, cenv, closure.env, e)
  ...
  def evalArgs(args: List[Exp], params: List[FunParam], env: Env, cenv: ClassEnv, declenv: Env, e: Exp): Env = {
