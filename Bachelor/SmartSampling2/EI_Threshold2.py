...
plotting_obj.plot_expected_improvement(delta = 1, sig = plotting_obj.optimizer.sigma)
...
# plot an arrow to point out the maximum of the EI

plotting_obj.ax_arr.arrow(1.8, 0.2, 0, -0.8, head_width = 0.15, head_length = 0.2, fc = 'k', ec = 'k')
...
# plotting_obj.show()
plotting_obj.save("../Rapport/figures/EI/EI_Threshold2.png")
