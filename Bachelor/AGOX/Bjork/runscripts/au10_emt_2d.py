...
for run_idx in range(10):
    ...
    # Database
    db_path = "kappa2/db{}.db".format(database_index)  # From input argument!
    ...
    agox = AGOX(collector, relaxer, acquisitor, evaluator, database, seed=run_idx)
